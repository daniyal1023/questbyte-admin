...
Admin page for the HD Wallpapers app. Static HTML, talks to Supabase directly.
...
Source of truth lives in the app repo at `admin/index.html` — copy it here to redeploy.
